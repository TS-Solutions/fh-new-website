                ...
                <div class="col-md-4 heading-section meal">
                    ...
                    <div class="row green-box">
                        <div class="text-box">
                            ...
                            <input type="hidden" name="used_calories" class="used_calories" value="0">
                            <input type="hidden" name="used_protein" class="used_protein" value="0">
                            <input type="hidden" name="used_carb" class="used_carb" value="0">
                            <input type="hidden" name="used_fat" class="used_fat" value="0">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center meal-selection">
                            <div class="col-md-4 text-center meal-type">
                                <div>
                                    <div class="select-img">
                                        <img class="double-box1" src="{{ asset('new_frontend_assets/img/breakfastbox.png') }}" alt="">
                                    </div>
                                    <img class="single-box1" src="{{ asset('new_frontend_assets/img/breakfastbox.png') }}" alt="">
                                </div>
                                <h4 class="heading">Breakfast</h4>
                                <input type="text" name="breakfast_count" class="form-control input-type input-number breakfast_count" value="0" min="0" max="2">
                                <p>Meal</p>
                            ...
                            <div class="col-md-4 text-center meal-type">
                                <div>
                                    <div class="select-img">
                                        <img class="double-box2" src="{{ asset('new_frontend_assets/img/lunchbox.png') }}" alt="">
                                    </div>
                                    <img class="single-box2" src="{{ asset('new_frontend_assets/img/lunchbox.png') }}" alt="">
                                </div>
                                <h4 class="heading">Lunch</h4>
                                <input type="text" name="lunch_count" class="form-control input-type input-number lunch_count" value="0" min="0" max="2">
                                <p>Meals</p>
                                <div tabindex="1" id="bowlb" class="bowl-box">
                                </div>
                            ...
                            <div class="col-md-4 text-center meal-type">
                                <div>
                                    <div class="select-img">
                                        <img class="double-box3" src="{{ asset('new_frontend_assets/img/dinnerbox.png') }}" alt="">
                                    </div>
                                    <img class="single-box3 pad5" src="{{ asset('new_frontend_assets/img/dinnerbox.png') }}" alt="">
                                </div>
                              <h4 class="heading">Dinner</h4>
                              <input type="text" name="dinner_count" class="form-control input-type input-number dinner_count" value="0" min="0" max="2">
                              <p>Meals</p>
                              <div tabindex="1" id="bowlb" class="bowl-box">
                              </div>
                    ...
                    <div class="row justify-content-center menu">
                        <div class="d-flex align-items-center bottom-menu justify-content-between">
                            ...
                            <div class="img1-box">
                                ...
                                <div class="text-pos">
                                    <input type="text" name="salad_count" class="form-control text input-number salad_count" value="1" min="1" max="2">
                                </div>
                            </div>
                            <div class="img2-box">
                                <div class="img-pos">
                                ...
                                <div class="text-pos2">
                                    <input type="text" name="snack_count" class="form-control text input-number snack_count" value="1" min="1" max="2">
                                </div>
                            </div>
                            <div class="toggle2">
                                <div class="wrapper2">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Egg" id="r1" />
                            ...
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Salmon" id="r2" />
                            ...
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Shrimp" id="r3" />
                        ...
                        <div class="row justify-content-center">
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Red Meat" id="r4" />
                            ...
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Chicken" id="r5" />
                            ...
                            <div tabindex="1" id="mealbox2" class="col-md-4 text-center meal-box">
                                <input type="checkbox" name="unliked_items[]" class="unliked_items" value="Nuts" id="r6" />
                        ...
                        <div class="note-form">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control additional_notes" id="input-text" name="additional_notes" autocomplete="off" placeholder="Note if any allergies" onchange="setAdditionalNotes()">
                            </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center pt-4">
                            ...
                            <div class="btn-toolbar justify-content-start" role="group"
                                ...
                                <input type="radio" class="btn-check" name="no_of_weeks" id="abtnradio3" value="4" autocomplete="off" checked>
                                <label class="btn btn-date m-2" for="abtnradio3">4 Week</label>
                            </div>
                        </div>

                        <div class="row justify-content-center pt-4 days">
                            <p class="text-green-p justify-content-start ml-2 text-left">Skipped Day
                                &nbsp;
                            ...
                            <div class="btn-group days-buttons justify-content-start" role="group"
                                ...
                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-A" autocomplete="off" value="Saturday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-A">Sa</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-B" autocomplete="off" value="Sunday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-B">Su</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-C" autocomplete="off" value="Monday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-C">Mo</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-D" autocomplete="off" value="Tuesday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-D">Tu</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-E" autocomplete="off" value="Wednesday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-E">We</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="checkbox-group-1-F" autocomplete="off" value="Thursday">
                                <label class="btn btn-date-days m-2" for="checkbox-group-1-F">Th</label>

                                <input type="radio" name="skipped_day" class="btn-check" id="btncheck7" autocomplete="off" disabled  value="Friday">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="desc" id="deliverytab3">
                                ...
                                <div class="dropdown m-2">
                                    ...
                                    <select class="btn btn-dropdown pickup_branch" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" title="Eastern Region" name="pickup_branch" >
                                        <div class="dropdown-menu">
                ...
                <div class="container white payment">
                    <div class="row justify-content-center p-5">
                        ...
                        <div class="col-md-4 staff left-side">
                            <div class="row">
                                <h4> <span id="payment_meal"></span> Plan</h4>
                                <img src="{{ asset('new_frontend_assets/img/meal-box.png') }}" alt="">
                            </div>
                            <div class="row">
                                <div class="main">
                                    <h4 class="heading">Total Price</h4>
                                    <p class="body"> <span id="payment_total"></span> <span>SAR</span></p>
                                </div>
                                <div class="details">
                                    <h4 class="heading">VAT</h4>
                                    <p class="body"><span id="payment_vat"></span>  <span>SAR</span></p>


                                    <h4 class="heading" id="payment_delivery_heading">Delivery</h4>
                                    <p class="body" id="payment_delivery_p" ><span id="payment_delivery"></span>  <span>SAR</span></p>

                                </div>
                                <hr>
                                <div class="intake">
                                    <p class="heading">Average Daily Intake</p>
                                    <p class="body"><span id="payment_calories"></span>&nbsp;<span>Calories</span></p>
                                    <p class="body"><span id="payment_protein"></span>g&nbsp;<span>Protein</span></p>
                                    <p class="body"><span id="payment_carb"></span>g&nbsp;<span>Carb</span></p>
                                    <p class="body"><span id="payment_fat"></span>g&nbsp;<span>Fat</span></p>
                                </div>
                                <hr>
                                <div id="payment_delivery_address_div">
                                    <div class="intake">
                                        <p class="heading">Delivery Address</p>
                                        <p class="body"><span id="payment_delivery_address"></span></p>
                                    </div>
                                    <a class="switch" href="#" onclick="switchVisible6();">Switch to free pickup</a>
                                </div>
                                <div id="payment_pickup_div">
                                    <div class="intake">
                                        <p class="heading">Pickup</p>
                                        <p class="body"><span id="pickup_address"></span></p>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-8 right-side">
                            ...
                            <div class="row bill">
                                <div class="row details">
                                    ...
                                    <div class="col-md-2 body-bold">
                                        <p> <span id="payment_breakfast"></span> </p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                            ...
                            <div class="row bill">
                                <div class="row details">
                                    ...
                                    <div class="col-md-2 body-bold">
                                        <p><span id="payment_lunch"></span></p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                            ...
                            <div class="row bill">
                                <div class="row details">
                                    ...
                                    <div class="col-md-2 body-bold">
                                        <p><span id="payment_dinner"></span></p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                            ...
                            <div class="row bill">
                                <div class="row details">
                                    ...
                                    <div class="col-md-2 body-bold">
                                        <p><span id="payment_salad"></span></p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                            ...
                            <div class="row bill">
                                <div class="row details">
                                    ...
                                    <div class="col-md-2 body-bold">
                                        <p><span id="payment_snack"></span></p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                            ...
                            <div class="row heading">
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between">
                                        <p class="field-inline-block"> <span id="payment_skipped_day"></span> </p>
                            ...
                            <div class="row heading">
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between">
                                        <p class="field-inline-block"> <span id="payment_weeks"></span> weeks</p>
                                        <a class="field-inline-block float-right" href="#"
                                            onclick="switchVisible5();"> Edit</a>
                                    </div>
                                </div>
                            ...
                            <div class="row heading">
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between">
                                        <p class="field-inline-block"> <span id="payment_start_date"></span> </p>
                                        <a class="field-inline-block float-right" href="#"
                                            onclick="switchVisible5();"> Edit</a>
                                    </div>
                                </div>
                            ...
                            <div class="row heading">
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between">
                                        <p class="field-inline-block"> <span id="payment_unliked"></span> <br>
                                            <span id="payment_notes"></span>     
                                        </p>
                                        <a class="field-inline-block float-right" href="#"
...
@push('plugin-scripts')
    ...
    <script type="text/javascript">
        ...
        function setAdditionalNotes() {
            ...
            $('#payment_notes').text(additional_notes)
        }
        ...
        $( document ).ready(function() {
            ...
            var month = tomorrow_date.toLocaleString("default", { month: "short" });
            var day = tomorrow_date.toLocaleString("default", { day: "2-digit" });
            var formattedDate = month + "-" + day;
            $('#payment_start_date').text(formattedDate);
            ...
            //initially skipped day is null and no of weeks are 4
            $('#payment_skipped_day').text('');
            $('#payment_weeks').text('4');
            $('#payment_pickup_div').hide();
...
$('.btn-working').click(function (e) {
    ...
    fieldName = $(this).attr('data-field');
    type = $(this).attr('data-type');
    var input = $("input[name='breakfast_count']");
    var currentVal = parseInt(input.val());
    if (currentVal == 0) {
...
$('.btn-working').click(function (e) {
    ...
    fieldName = $(this).attr('data-field');
    type = $(this).attr('data-type');
    var input = $("input[name='lunch_count']");
    var currentVal = parseInt(input.val());
    if (currentVal == 0) {
...
$(document).ready(function () {
    ...
    $('.btn-working').click(function (e) {
        ...
        fieldName = $(this).attr('data-field');
        type = $(this).attr('data-type');
        var input = $("input[name='dinner_count']");
        var currentVal = parseInt(input.val());
        if (currentVal == 0) {
...
$('.input-number').change(function () {
    ...
    if (valueCurrent <= maxValue) {
        ...
        function show(str) {
            ...
            $('#payment_delivery_address_div').show();
            $('#payment_delivery_heading').show();
            $('#payment_delivery_p').show();
            $('#payment_pickup_div').hide();
            initAutocomplete();
        }
        ...
        function show2(sign) {
            ...
            $('#payment_delivery_address_div').hide();
            $('#payment_delivery_heading').hide();
            $('#payment_delivery_p').hide();
            $('#payment_pickup_div').show();
        ...
        function switchVisible6() {
            if (document.getElementById('deliveryopt')) {
                var unliked_items_text = "";
                $('input.unliked_items[type=checkbox]').each(function () {
                    var sThisVal = (this.checked ? $(this).val() : ""); 
                    if(sThisVal != ""){
                        unliked_items_text += sThisVal + "<br>";
                    }
                });
                $('#payment_unliked').html(unliked_items_text);
                var weeks = $("input[name=no_of_weeks]:checked").val();
                var skipped_day = $("input[name=skipped_day]:checked").val();
                $('#payment_skipped_day').text(skipped_day);
                $('#payment_weeks').text(weeks);

                var start_date = $("input[name=start_date]:checked").val();
                $('#payment_start_date').text(start_date);

                var delivery_option = $("input[name=delivery_option]:checked").val();
                if(delivery_option == "Delivery"){
                    $('#payment_delivery_address').text($('#autocomplete').val());
                }
                else{
                    var selected_branch = $( ".pickup_branch option:selected").text();
                    $('#pickup_address').text(selected_branch);   
                }


                var starting_from_text = $('#starting_from_span').text();
                const myArray = starting_from_text.split(" SAR");
                let starting_price = myArray[0];

                var total_days_temp = 6;
                if(skipped_day != undefined && skipped_day != null){
                    total_days_temp = 5;
                }

                total_price_temp = weeks * total_days_temp * starting_price;
                var delivery_charges_temp = 0;

                if (document.getElementById('deliveryopt').style.display == 'none') {
                    delivery_charges_temp = 200;
                    document.getElementById('deliveryopt').style.display = 'block';
                    document.getElementById('bottombtn5').style.display = 'block';
                    document.getElementById('mealtype').style.display = 'none';
                    document.getElementById('selectmeal1').style.display = 'none';
                ...
                var temp_vat = (total_price_temp + delivery_charges_temp) * 0.15; 

                $('#payment_total').text(total_price_temp);
                $('#payment_vat').text(temp_vat);
                $('#payment_delivery').text(delivery_charges_temp);
            }
        }
    ...
    $( document ).ready(function() {
      ...
      $(".breakfast_count").change(function() {
        ...
        $('#payment_breakfast').text(breakfast_count);
        $('#payment_lunch').text(lunch_count);
        $('#payment_dinner').text(dinner_count);
        $('#payment_salad').text(salad_count);
        $('#payment_snack').text(snack_count);
    ...
    function calculate_meal_amount(breakfast_count, lunch_count, dinner_count, salad_count, snack_count) {
      ...
      $('.used_calories').val(used_calories);
      $('.used_protein').val(used_proteins);
      $('.used_carb').val(used_carbs);
      $('.used_fat').val(used_fats);

      $('#payment_calories').text(used_calories);
      $('#payment_protein').text(used_proteins);
      $('#payment_carb').text(used_carbs);
      $('#payment_fat').text(used_fats);
