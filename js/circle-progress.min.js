...
function _typeof(t) {
    ...
    function h(t, n, i, a, s) {
        var o, u = "string" == typeof t ? h.easings[t] : t;
    ...
    return h.easings = {
        ...
        function s(t) {
            ...
            (t.circleProgress = this).doc = n, t.setAttribute("role", "progressbar"), this.el = t, r = _objectSpread(_objectSpread({}, s.defaults), r), Object.defineProperty(this, "_attrs", {
                value: {},
                enumerable: !1
            }), e = "valueOnCircle" === r.textFormat ? 16 : 8, this.graph = {
                paper: i(t, 100, 100),
                value: 0
            }, this.graph.paper.svg.setAttribute("class", "circle-progress"), this.graph.circle = this.graph.paper.element("circle").attr({
        ...
        return _createClass(s, [{
            ...
            value: function () {
                ...
                this._isIndeterminate() ? this._updateText(this.value, i, a) : (e = this.clockwise, r = this._valueToAngle(), this.graph.circle.attr("r", a), "none" !== this.animation && this.value !== this.graph.value ? h(this.animation, this.graph.value, this.value - this.graph.value, this.animationDuration, function (t) {
                    n._updateText(Math.round(t), (2 * i + r) / 2, a), r = n._valueToAngle(t), n.graph.sector.attr("d", s._makeSectorPath(50, 50, a, i, r, e))
